...
function Prototype() {
  ...
  const description = 'Prototype layout with curated UI/UX works and visual storytelling.';
  const stuplanSlides = [
    'Rectangle-1.webp',
    'Rectangle-2.webp',
    'Rectangle-3.webp',
  ...
  return (
    <>
      <Seo title="Prototype" description={description} path="/prototype" />
      ...
      <nav className={`prototype-menu ${isMenuOpen ? 'is-open' : ''}`}>
        ...
        <NavLink to="/prototype-slider" onClick={() => setIsMenuOpen(false)}>
          Section Slider
        </NavLink>
      </nav>
      ...
      <section className="intro-card hover-lift">
        ...
        <p className="intro-text">
          I'm Hafizh Alexander, a passionate graphic designer exploring user interface design for game development.
          An undergraduate at Surabaya State University. Currently a third-year Informatics student.
        </p>
      </section>
      ...
      <div className={`more-about-me-4 hover-lift ${showPortfolio ? 'show-portfolio' : ''}`}>
      ...
      <section className="stuplan-card hover-lift" ref={stuplanRef}>
        ...
        <div className="card-link">[ MORE HERE ]</div>
